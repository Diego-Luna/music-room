...
1.  **`OfflineCache`**: La base de datos local Hive en [offline_cache.dart](file:///Users/diegoluna/Documents/42course/music-room/frontend/music_room_app/lib/config/offline_cache.dart). Cachea los modelos de `Room` and `Track` y gestiona la cola de acciones pendientes en memoria local de forma persistente.
