...
_Solo se evaluarán si la parte obligatoria es perfecta._
...
- **Real-Time Collaboration:** `web_socket_channel` (Para el Editor de Playlist y los Votos en vivo) _aprender_.
- **Authentication:** `firebase_auth`, `google_sign_in`, `flutter_facebook_auth`, `flutter_secure_storage`
- **Offline Storage (Para Bonus):** `hive_ce` (Base de datos local ultrarrápida para manejar el caché when no hay red) _aprender_.
...
- **Build** para IOS y andorid en la nube con `Codemagic` _learn_
- **Buidl** GitHub Actions? _its possible_
...
- [x] Inicializar repositorio de Git y projecto para el manejo de tiempo
- [x] [[Arquitectura REST]] : Hablar de la organisacion de la API y el la estrcutia de tados .
- [x] Enfocarse en conseguir el MVP **(1 - 4 semanas)**
  - [x] **(1 - 2 semanas)** Primera seccion
    - [x] User Accounts
    - [x] Core Services
      - [x] Music Track Vote
      - [x] Music Control Delegation
  - [x] **(1 - 2 semanas)** Segunda seccion
    - [x] CD / CI (para el proyecto configuracion WEB/ APP)
    - [x] Idratacion de la API
    - [x] Music Playlist Editor (WebSockets)
- [/] Bonus **(1 - 2 semanas)**
  - [x] **poca configuraicon** Multi-platform support
  - [?] **IoT Reflection**
