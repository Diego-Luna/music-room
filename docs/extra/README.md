...
Pas exigée par le PDF. Utile à l’équipe (et pour les bonus).
...
| [frontend-tests.md](frontend-tests.md) | Comment lancer les tests front |
| [lexique.md](lexique.md) | Jargon review / CI |
| [note-cors-https.md](note-cors-https.md) | CORS `https://localhost:8443` (Facebook Login local) |

La doc **soutenance** est dans [`../sujet/`](../sujet/).
